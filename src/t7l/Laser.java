...
public class Laser {
	...
	public void render(GameContainer arg0, StateBasedGame arg1, Graphics g) throws SlickException {
		...
		if(axe == 0) {
			//horizontal
			g.fillRect((float)280+360-World.getGrid().getColumns()*100*World.getRenderScale()/2, (float)(pos*100+25)*World.getRenderScale()+360-World.getGrid().getColumns()*100*World.getRenderScale()/2, (float)100*World.getGrid().getRows()*World.getRenderScale(), (float)50*World.getRenderScale());
		}
		else {
			//vertical
			g.fillRect((float)(pos*100+25)*World.getRenderScale()+280+360-World.getGrid().getColumns()*100*World.getRenderScale()/2, (float)+360-World.getGrid().getColumns()*100*World.getRenderScale()/2, (float)50*World.getRenderScale(), (float)100*World.getGrid().getColumns()*World.getRenderScale());
		}
