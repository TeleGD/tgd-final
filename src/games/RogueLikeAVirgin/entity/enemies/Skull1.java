...
public class Skull1 extends Enemy{
	...
	public Skull1(float x, float y) {
		...
		hp=1;
		try {
			this.imgB=new Image("ressources/images/RogueLikeAVirgin/squeletteBas.png");
			this.imgT=new Image("ressources/images/RogueLikeAVirgin/squeletteHaut.png");
			this.imgR=new Image("ressources/images/RogueLikeAVirgin/squeletteDroite.png");
			this.imgL=new Image("ressources/images/RogueLikeAVirgin/squeletteGauche.png");
