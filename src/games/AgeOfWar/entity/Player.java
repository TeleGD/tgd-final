...
public class Player {
	...
	public Player(int num, int gold, int HP ) // init num joueur, or et pv 
	{
		ID=num;
		try {
			sadMusic=new Music("ressources/musics/AgeOfWar/sadMusic.ogg");
			goodMusic = new Music("ressources/musics/AgeOfWar/I_LIKE_TRAINS.ogg");
		...
		PVMax=HP;
		try {
			base1=new Image("ressources/images/AgeOfWar/base_1_a1.png");
			base2=new Image("ressources/images/AgeOfWar/base_2_a1.png");
...
//			System.exit(0);
	...
	public void update(GameContainer container,StateBasedGame game, int delta) throws SlickException
	{
		...
		if(xp>=xpMax && age < 3)
		{
			...
			PV=(int)(PV*1.25);
			base1=new Image("ressources/images/AgeOfWar/base_1_a"+age+".png");
			base2=new Image("ressources/images/AgeOfWar/base_2_a"+age+".png");
			
			// Gestion musique du fond sonore : vérifie qu'il est le premier à lancer cette musique, sinon ne fait rien
			if (needMusic()) {
				try {
					musicAge =new Music("ressources/musics/AgeOfWar/age" + age + ".ogg");
