...
public class Minion {
	...
	public Minion(int idOwner, int age, int type) {
		...
		if (idOwner != 0) {
			...
			try {
				surprise=new Sound("ressources/musics/AgeOfWar/surprise.ogg");
			...
			try {
				if (type <= 3) {
					image=new Image("ressources/images/AgeOfWar/stick_"+type+"_a"+age+".png");
					this.bruit=new Sound("ressources/musics/AgeOfWar/criWilhelm.ogg");
				}
				if (type >= 4 ) {
					image=new Image("ressources/images/AgeOfWar/stick_"+ (type - 3) +"_a"+age+".png");
					image=image.getScaledCopy(2);
					this.y -= 90;
					this.bruit=new Sound("ressources/musics/AgeOfWar/headshot.ogg");
