...
public class World extends BasicGameState {
    ...
    public void init(final GameContainer container, final StateBasedGame game) throws SlickException {
    	...
    	fond = new Image("ressources/images/AgeOfWar/fond.png");
    	fondBadEnd = new Image("ressources/images/AgeOfWar/yoda.png");
    	fondGoodEnd = new Image("ressources/images/AgeOfWar/goodEnd.png");
    	music1=new Music("ressources/musics/AgeOfWar/age1.ogg");
    	pegi = new Sound("ressources/musics/AgeOfWar/pegi18.ogg");
    }
