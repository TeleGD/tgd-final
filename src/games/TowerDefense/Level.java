...
public class Level {
	...
	public Level(Player p) {
		...
		pl = p;
		try {
			sprite0 = new Image("ressources/images/TowerDefense/chemin.png");
			sprite1 = new Image("ressources/images/TowerDefense/mur.png");
			sprite2 = new Image("ressources/images/TowerDefense/spawn.png");
			base = new Image("ressources/images/TowerDefense/Base.png");
