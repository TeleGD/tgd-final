package games.SpaceShooter.entities.bonus;
...
public class Bonus extends games.SpaceShooter.entities.Movable implements Circle {
	...
	public Bonus(double x, double y, int radius, Player player, int numeroBonus) {
		...
		try {
			this.spriteBonus=new Image("ressources/images/SpaceShooter/bonus/bonus"+this.type+".png");
	...
	public void render(GameContainer container, StateBasedGame game, Graphics g) throws SlickException {
		...
		g.fillOval((float)(x-radius),(float)(y-radius),2*radius,2*radius);
