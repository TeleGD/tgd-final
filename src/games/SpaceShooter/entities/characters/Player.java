...
public class Player extends games.SpaceShooter.entities.Movable implements Circle{
	...
	private String nameSprite = "ressources/images/SpaceShooter/projectiles/playerShot.png";
	...
	public Player(double centerPointX, double centerPointY, int radius, ArrayList<Projectile> ProjectileList) {
		...
		try {
			image=new Image("ressources/images/SpaceShooter/ship/En3.png");
		...
		try {
			imageInvul = new Image("ressources/images/SpaceShooter/ship/En3Invulnerable.png");
